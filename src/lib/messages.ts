...
export const FLASH_MESSAGES = {
    // Success Messages
    "account-created": "Account created! Please check your KTH inbox to activate your account.",
    ...
    "program-upgraded": "Programme upgraded successfully! Please log in to see your new courses.",
